...
The codebase has been completely refactored, resulting in a **new and independent integration**. It is not compatible with configurations or entities from the orignal fork. The codebase has been improved to be compliant with Home Assistant.
